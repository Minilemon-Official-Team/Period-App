          ...
          <div className="layout-content-container flex flex-col max-w-[480px] flex-1">
            <div className="flex flex-col items-center justify-center p-4">
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="text-2xl font-bold font-display text-slate-800">Femina</span>
              </div>
              <div className="w-full">
                <div className="flex flex-wrap justify-between gap-3 p-4 text-center">
                  <div className="flex w-full flex-col gap-3">
                    <p className="text-slate-800 text-4xl font-black leading-tight tracking-[-0.033em] font-display">Welcome back</p>
                    <p className="text-slate-500 text-base font-normal leading-normal font-display">Log in to your account</p>
                  </div>
                </div>

                <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                  <label className="flex flex-col min-w-40 flex-1">
                    <p className="text-slate-800 text-base font-medium leading-normal pb-2 font-display">Email</p>
                    <input
                ...
                <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                  <label className="flex flex-col min-w-40 flex-1">
                    <p className="text-slate-800 text-base font-medium leading-normal pb-2 font-display">Password</p>
                    <div className="flex w-full flex-1 items-stretch rounded-xl">
                      ...
                      />
                      <button onClick={() => setShowPassword(!showPassword)} className="text-slate-500 flex border-none bg-slate-200 items-center justify-center pr-4 rounded-r-xl border-l-0 hover:bg-slate-300 transition-colors">
                ...
                <p className="text-slate-500 text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center underline font-display cursor-pointer hover:text-primary">Forgot password?</p>
